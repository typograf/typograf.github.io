...
export default function Footer(props) {
    return <footer class="footer">
        <div class="footer__left">
            ...
            <div class="footer__item">
                <a href="https://github.com/typograf/typograf.github.io/issues/new" target="_blank">{i18n('report-error')}</a>
            </div>
        ...
        <div class="footer__right">
            <div class="footer__item">
                <span>{i18n('powered-by')}</span> <a href="https://github.com/typograf/typograf/releases/" target="_blank">Typograf <span class="footer__version">{Typograf.version}</span></a>
            </div>
            <div class="footer__item">
